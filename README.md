...
# Instructions
  ...
  1. Download GTAIV-BudgetCalculator.py
  2. Place in "\<path-to-game>\GTAIV" (where GTAIV.exe is)
  3. Run GTAIV-BudgetCalculator.py
  4. Put your output value in the VehicleBudget line in "\<path-to-game>\GTAIV\plugins\GTAIV.EFLC.FusionFix.ini"
  5. Adjust values as necessary

##

Script generated with generative AI (ChatGPT) and edited afterwards.
